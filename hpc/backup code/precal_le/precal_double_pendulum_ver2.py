...
def cal_le (x):
    _, le = f_t(dyn, double_pendulum, linearized_double_pendulum, 0.001, x, 700)
    return le
# precal_dp_15: 51
# precal_dp_16: 21
...
with MPIPoolExecutor(max_workers=cores-1) as pool:
    result = pool.map(cal_le, points)
    le_list.append(result)
    print (result)
# print (points[0])
# for i in points:
...
np.save('/home/015970994/masterchaos/precal_le/Double_pendulum/precal_dp_test', zs)
np.save('/home/015970994/masterchaos/precal_le/Double_pendulum/precal_dp_points_test', X_reshaped)